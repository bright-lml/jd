...
function batchReplace() {
    ...
    remoteContent = remoteContent.replace(new RegExp(process.env.BANSTR, "g"), 'DONOTUSEACTION');
    return remoteContent
}
async
function downloader_jd() {
    await download("https://cyccy.top/jd_scripts/utils/jdShareCodes.js", "./utils/jdShareCodes", "互助码");
    if (/require\(['"`]{1}.\/jdCookie.js['"`]{1}\)/.test(remoteContent)) await download("https://cyccy.top/jd_scripts/jdCookie.js", "./jdCookie.js", "京东Cookies");
    if (remoteContent.indexOf("jdFruitShareCodes") > 0) {
        await download("https://cyccy.top/jd_scripts/jdFruitShareCodes.js", "./jdFruitShareCodes.js", "东东农场互助码")
    }
    if (remoteContent.indexOf("jdPetShareCodes") > 0) {
        await download("https://cyccy.top/jd_scripts/jdPetShareCodes.js", "./jdPetShareCodes.js", "京东萌宠")
    }
    if (remoteContent.indexOf("jdPlantBeanShareCodes") > 0) {
        await download("https://cyccy.top/jd_scripts/jdPlantBeanShareCodes.js", "./jdPlantBeanShareCodes.js", "种豆得豆互助码")
    }
    if (remoteContent.indexOf("jdSuperMarketShareCodes") > 0) await download("https://cyccy.top/jd_scripts/jdSuperMarketShareCodes.js", "./jdSuperMarketShareCodes.js", "京小超互助码");
    if (remoteContent.indexOf("jdFactoryShareCodes") > 0) {
        await download("https://cyccy.top/jd_scripts/jdFactoryShareCodes.js", "./jdFactoryShareCodes.js", "东东工厂互助码")
    }
    if (remoteContent.indexOf("jdDreamFactoryShareCodes") > 0) {
        await download("https://cyccy.top/jd_scripts/jdDreamFactoryShareCodes.js", "./jdDreamFactoryShareCodes.js", "京喜工厂互助码")
    }
    if (remoteContent.indexOf("jdJxncTokens.js") > 0) {
        await download("https://cyccy.top/jd_scripts/jdJxncTokens.js", "./jdJxncTokens.js", "京喜农场token")
    }
    if (remoteContent.indexOf("new Env('京喜农场')") > 0) {
        await download("https://cyccy.top/jd_scripts/jdJxncTokens.js", "./jdJxncTokens.js", "京喜农场Token");
        await download("https://cyccy.top/jd_scripts/jdJxncShareCodes.js", "./jdJxncShareCodes.js", "京喜农场分享码");
        await download("https://cyccy.top/jd_scripts/USER_AGENTS.js", "./USER_AGENTS.js", "USER_AGENTS")
    }
}
async
function downloader_notify() {
    await download("https://cyccy.top/jd_scripts/sendNotify.js", "./sendNotify.js", "统一通知")
}
async
function downloader_user_agents() {
    await download("https://cyccy.top/jd_scripts/JS_USER_AGENTS.js", "./JS_USER_AGENTS.js", "云端UA")
}
async
function downloader_user_agents() {
    await download("https://cyccy.top/jd_scripts/USER_AGENTS.js", "./USER_AGENTS.js", "云端UA")
}
async
function download(url, path, target) {
    let response = await axios.get(url);
    let fcontent = response.data;
    fcontent = fcontent.replace(new RegExp(process.env.BANSTR, "g"), 'DONOTUSEACTION');
